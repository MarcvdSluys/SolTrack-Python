...
class RiseSet:
    ...
    def computeSunRiseSet(self, location, time, rsAlt=0.0, useDegrees=False, useNorthEqualsZero=False):
        ...
        # Store results:
        self.transitTime     = tmRad[0]*R2H  # Transit time - radians -> hours
        self.riseTime        = tmRad[1]*R2H  # Rise time - radians -> hours
        self.setTime         = tmRad[2]*R2H  # Set time - radians -> hours
